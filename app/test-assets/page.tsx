          ...
          <Card className="bg-white/5 border-white/10">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  <span className={`text-xs px-2 py-1 rounded ${videoUrl ? (videoUrl.startsWith('http') ? 'bg-green-500/20 text-green-400' : 'bg-yellow-500/20 text-yellow-400') : 'bg-gray-500/20 text-gray-400'}`}>
                    {videoUrl ? (videoUrl.startsWith('http') ? 'Supabase URL' : 'Local Fallback') : 'Not Available'}
                  </span>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  <div className={`w-3 h-3 rounded-full ${videoLoading ? 'bg-yellow-500' : videoUrl ? (videoUrl.startsWith('http') ? 'bg-green-500' : 'bg-blue-500') : 'bg-gray-500'}`} />
                  <span className="text-sm text-gray-300">
                    {videoLoading ? 'Loading...' : videoUrl ? (videoUrl.startsWith('http') ? 'Loaded from Supabase' : 'Using local fallback') : 'Not available'}
                  </span>
                </div>
              </div>
            </div>
