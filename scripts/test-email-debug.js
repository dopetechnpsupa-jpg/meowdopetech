...
async function testEmailService() {
  ...
  if (!process.env.RESEND_API_KEY) {
    ...
    console.log('💡 Make sure to set RESEND_API_KEY in your .env.local file or Netlify environment variables');
    return;
  }

  if (!process.env.ADMIN_EMAIL) {
    console.error('❌ ADMIN_EMAIL not found in environment variables');
    console.log('💡 Make sure to set ADMIN_EMAIL in your .env.local file or Netlify environment variables');
    return;
  }
